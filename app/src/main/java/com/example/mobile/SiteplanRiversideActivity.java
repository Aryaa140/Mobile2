...
public class SiteplanRiversideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setContentView(R.layout.activity_siteplan_riverside);
    ...
    private void initViews() {
        ...
        try {
            ...
            // Pastikan toolbar title sesuai
            if (toolbar != null) {
                toolbar.setTitle("Site Plan Riverside");
            }
