...
public class SiteplanGardenActivity extends AppCompatActivity {
    private static final String TAG = "SiteplanGardenActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            // ✅ PERBAIKAN: Gunakan layout yang benar - activity_siteplan_garden
            setContentView(R.layout.activity_siteplan_garden);
            Log.d(TAG, "Layout inflated successfully");

            // ✅ PERBAIKAN: Enable EdgeToEdge SETELAH setContentView
        ...
        // ✅ PERBAIKAN: WindowInsets setelah semua view diinisialisasi
    ...
    private void setStatusBarColor() {
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                // For light status bar icons (white icons on dark background)
    ...
    private void initViews() {
        ...
        try {
            ...
            // ✅ PERBAIKAN: Set title yang benar untuk Garden
            if (toolbar != null) {
                toolbar.setTitle("Site Plan Garden");
            }
    ...
    private void setupImage() {
        try {
            ...
            int imageResource = getIntent().getIntExtra("IMAGE_RESOURCE", R.drawable.site_plan_riverside);
