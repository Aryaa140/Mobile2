    ...
    public interface ApiService {
        ...
        Call<BasicResponse> addProyek(
                ...
                @Field("username_penginput") String usernamePenginput,
                @Field("nama_penginput") String namaPenginput
        );
        ...
        @POST("trigger_proyek_fcm.php")
        Call<BasicResponse> triggerProyekFCMNotification(@Body Map<String, String> fcmData);

        // Method untuk delete old news items
        @FormUrlEncoded
        @POST("delete_old_news.php")
        Call<BasicResponse> deleteOldNewsItems(
                @Field("days_old") int daysOld,
                @Field("status") String status
        );
        @GET("get_proyek.php")
        Call<ProyekResponse> getProyekForPromo();

        // Di ApiService.java - tambahkan method ini
        ...
        @FormUrlEncoded
        @POST("delete_expired_promo.php")
        Call<BasicResponse> deleteExpiredPromo(
                @Field("id_promo") int idPromo,
                @Field("status") String status
        );
        ...
        Call<BasicResponse> deleteProyek(
                ...
                @Field("nama_proyek") String namaProyek,
                @Field("username") String username,
                @Field("deleted_by") String deletedBy
        );
        ...
        @FormUrlEncoded
        @POST("api_proyek.php")
        Call<ProyekHistoriResponse> getProyekHistori(
                @Field("action") String action,
                @Field("limit") int limit,
                @Field("offset") int offset,
                @Field("for_news") String forNews
        );
        ...
        Call<BasicResponse> deleteFasilitas(
                ...
                @Field("username") String username,
                @Field("deleted_by") String deletedBy,
                @Field("proyek_name") String proyekName
        );

        // PERBAIKAN: Gunakan @FormUrlEncoded dengan benar
        @FormUrlEncoded
        @POST("api_hunian.php")
        Call<BasicResponse> addHunianComprehensive(
                @Field("action") String action,
        ...
        // DI ApiService.java - tambahkan method baru
        @GET("get_all_news_histori.php")
        Call<AllNewsHistoriResponse> getAllNewsHistori(
                @Query("limit") int limit,
                @Query("offset") int offset,
                @Query("filter") String filter
        );

        @GET("get_hunian_histori.php")
        Call<HunianHistoriResponse> getHunianHistori(
                @Query("limit") int limit,
                @Query("offset") int offset,
                @Query("for_news") String forNews
        );

        @GET("get_proyek_histori.php")
        Call<ProyekHistoriResponse> getProyekHistori(
                @Query("limit") int limit,
                @Query("offset") int offset,
                @Query("for_news") String forNews
        ...
        // DI ApiService.java - TAMBAHKAN METHOD BARU
        @GET("get_deleted_hunian_histori.php")
        Call<List<DeletedHunianResponse>> getDeletedHunianHistori();

        @GET("get_deleted_proyek_histori.php")
        Call<List<DeletedProyekResponse>> getDeletedProyekHistori();

        @FormUrlEncoded
        @POST("hunian_histori_handler.php")
        Call<BasicResponse> addHunianHistori(
                @Field("action") String action,
                @Field("hunian_id") int hunianId,
                @Field("nama_hunian") String namaHunian,
                @Field("nama_proyek") String namaProyek,
                @Field("luas_tanah") int luasTanah,
                @Field("luas_bangunan") int luasBangunan,
        ...
        @FormUrlEncoded
        @POST("proyek_histori_handler.php")
        Call<BasicResponse> addProyekHistori(
                @Field("action") String action,
                @Field("proyek_id") int proyekId,
                @Field("nama_proyek") String namaProyek,
                @Field("lokasi_proyek") String lokasiProyek,
                @Field("penginput") String penginput,
                @Field("status") String status,
        ...
        @GET("get_hunian_by_proyek.php")
        Call<HunianResponse> getHunianByProyekId(@Query("id_proyek") int idProyek);

        // Method dengan nama_proyek (untuk kasus lain)
        @GET("get_hunian_by_proyek.php")
        Call<HunianResponse> getHunianByProyekName(@Query("nama_proyek") String namaProyek);
        ...
        // Atau gunakan endpoint yang sudah ada dengan parameter tambahan
        @GET("api/get-news-histori")
        Call<NewsHistoriResponse> getNewsHistori(
                @Query("limit") int limit,
                @Query("offset") int offset,
                @Query("for_news") String forNews,
                @Query("type") String type // Optional: filter by type
        );
