                    ...
                    new OnSuccessListener<String>() {
                        ...
                        public void onSuccess(String promoId) {
                            runOnUiThread(() -> {
                                ...
                                Toast.makeText(com.example.mobile.InputPromoActivity.this, "Promo berhasil disimpan", Toast.LENGTH_SHORT).show();
                    ...
                    new OnFailureListener() {
                        ...
                        public void onFailure(Exception e) {
                            runOnUiThread(() -> {
                                ...
                                Toast.makeText(com.example.mobile.InputPromoActivity.this, errorMsg, Toast.LENGTH_LONG).show();
                                ...
                                if (e.getMessage().contains("object does not exist")) {
                                    Toast.makeText(com.example.mobile.InputPromoActivity.this,
