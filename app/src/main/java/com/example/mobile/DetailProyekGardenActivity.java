...
public class DetailProyekGardenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_proyek_garden);
        ...
        try {
            ...
            if (TopAppBar != null) {
                TopAppBar.setNavigationOnClickListener(v -> {
                    try {
                        Intent intent = new Intent(DetailProyekGardenActivity.this, ProyekActivity.class);
    ...
    private void openFullScreenImage() {
        try {
            Intent intent = new Intent(DetailProyekGardenActivity.this, SiteplanGardenActivity.class);
